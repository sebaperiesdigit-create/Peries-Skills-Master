...
**Not yet pushed to the hub or committed** — this feature exists only in the local working tree as of this note; both are separate, explicitly-triggered steps ("push hub" / an explicit commit request).
